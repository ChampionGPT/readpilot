    ...
    return (
      <div className="w-full h-full min-h-[500px] flex flex-col items-center justify-center p-8 text-center bg-surface">
        ...
        <button 
          ...
          className="px-8 py-3.5 bg-primary text-on-primary font-bold rounded-full text-base hover:brightness-110 active:scale-95 transition-all shadow-md cursor-pointer flex items-center gap-2"
        >
    ...
    <div className="w-full max-w-6xl mx-auto px-8 py-10 animate-in fade-in duration-500">
         ...
         <div className="flex items-center gap-3">
           <div className="hidden h-10 items-center gap-1 rounded-xl border border-outline-variant/20 bg-surface-container p-1 md:flex">
             <button
               ...
               className={`inline-flex h-8 items-center gap-2 rounded-lg px-3 text-sm font-bold transition-colors ${
                 libraryMode === 'all'
           ...
           {Object.keys(wereadByDir).length > 0 && (
             <button
                ...
                className="px-4 py-2.5 bg-primary/10 text-primary font-bold rounded-xl text-sm hover:bg-primary/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all cursor-pointer flex items-center gap-2"
             >
           ...
           <button
              onClick={() => setIsImportOpen(true)}
              className="px-5 py-2.5 bg-surface-container-high text-on-surface-variant font-bold rounded-xl text-sm hover:bg-surface-container-highest hover:text-on-surface transition-all cursor-pointer flex items-center gap-2"
           >
       ...
       <div className="mb-6 flex h-10 items-center gap-1 rounded-xl border border-outline-variant/20 bg-surface-container p-1 md:hidden">
         <button
           ...
           onClick={() => setLibraryMode('all')}
           aria-pressed={libraryMode === 'all'}
           className={`inline-flex h-8 flex-1 items-center justify-center gap-2 rounded-lg px-3 text-sm font-bold transition-colors ${
