...
- [生成方法论](references/companion-methodology.md)
- [设计原则](references/design.md)
- [设计系统](references/design-system.md)
- [Hub 模板](references/hub-template.md)
- [交互元素](references/interactive-elements.md)
- [progress.json schema](references/progress-schema.md)
...
3. 想维护伴读页：`docs/PROJECT_STRUCTURE.md` -> `skills/reading-companion-zh/SKILL.md` -> `docs/references/`
